...
function DashboardLayout() {
  ...
  return (
    <>
      ...
      <DbSection>
          <InfoBox color="bg-indigo-200" title='Buchungen' 
          ...
          <InfoBox color="bg-green-200" title='Umsatz' 
