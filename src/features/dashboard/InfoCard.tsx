...
function InfoCard({ id, title, rowContent }: { id: string; title: string, rowContent: ITodayCardBookingTypes[] | LoadingTypes}) {
    let border = "";
    let backgroundColor = "";
    let textColor = "";
    ...
    return (
      ...
      >
        ...
        ? 
          ...
          : Array.isArray(rowContent) && rowContent.map((el: ITodayCardBookingTypes) => (
            <InfoCardRow
              id={id}
              status={el.status}
              name={el.fullName}
